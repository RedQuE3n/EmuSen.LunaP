...
namespace EmuSen.LunaP.Tests
{
    ...
    public class LunaPaletteTests
    {
        ...
        [InlineData("LunaHudSurface", "#E61C1C1C")]
        [InlineData("LunaBorder", "#6E6E6E")]
        ...
        [InlineData("LunaAccent", "#007ACC")]
        [InlineData("LunaOnAccent", "#FFFFFF")]
        ...
        [InlineData("LunaHudSurface", nameof(LunaPalette.HudSurface))]
        [InlineData("LunaBorder", nameof(LunaPalette.Border))]
        ...
        [InlineData("LunaAccent", nameof(LunaPalette.Accent))]
        [InlineData("LunaOnAccent", nameof(LunaPalette.OnAccent))]
